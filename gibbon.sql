...
CREATE TABLE `gibbonActivityCategory` (
  ...
  `signUpChoices` int NOT NULL DEFAULT '3',
...
CREATE TABLE `gibbonActivityChoice` (
  `gibbonActivityChoiceID` int(12) UNSIGNED ZEROFILL NOT NULL,
  `gibbonActivityCategoryID` int(8) UNSIGNED ZEROFILL NOT NULL,
  `gibbonActivityID` int(8) UNSIGNED ZEROFILL NOT NULL,
...
CREATE TABLE `gibbonActivityPhoto` (
  `gibbonActivityPhotoID` int(12) UNSIGNED ZEROFILL NOT NULL,
  `gibbonActivityID` int(8) UNSIGNED ZEROFILL NOT NULL,
...
CREATE TABLE `gibbonApplicationFormLink` (
  `gibbonApplicationFormLinkID` int UNSIGNED NOT NULL,
...
CREATE TABLE `gibbonBehaviour` (
  ...
  `date` date NOT NULL,
  `gibbonPersonID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `type` enum('Positive','Negative','Observation') NOT NULL,
...
CREATE TABLE `gibbonBehaviourLetter` (
  ...
  `recordCountAtCreation` int NOT NULL,
  `body` text NOT NULL,
...
CREATE TABLE `gibbonFamilyAdult` (
  ...
  `contactPriority` int NOT NULL DEFAULT '1',
...
--
-- Table structure for table `gibbonFinancePettyCash`
--

CREATE TABLE `gibbonFinancePettyCash` (
  `gibbonFinancePettyCashID` int(12) UNSIGNED ZEROFILL NOT NULL,
  `gibbonSchoolYearID` varchar(3) NOT NULL,
...
(0012, 'fr_FR', 'Français - France', NULL, 'Y', 'Y', 'Y', 'dd/mm/yyyy', '/^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\\d\\d$/i', 'd/m/Y', 'N'),
...
CREATE TABLE `gibbonLibraryItem` (
  ...
  `gibbonLibraryItemIDParent` int DEFAULT NULL,
...
CREATE TABLE `gibbonMarkbookColumn` (
  ...
  `description` text NOT NULL,
  `columnColor` varchar(7) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `sequenceNumber` int UNSIGNED NOT NULL DEFAULT '0',
  `attachment` varchar(255) NOT NULL,
  `attainment` enum('Y','N') NOT NULL DEFAULT 'Y',
  `gibbonScaleIDAttainment` int(5) UNSIGNED ZEROFILL DEFAULT NULL,
...
CREATE TABLE `gibbonMessengerMailingList` (
  `gibbonMessengerMailingListID` int(8) UNSIGNED ZEROFILL NOT NULL,
  `name` varchar(60) NOT NULL,
  `active` enum('Y','N') NOT NULL DEFAULT 'Y',
  `timestampCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `gibbonMessengerMailingListRecipient` (
  `gibbonMessengerMailingListRecipientID` int(8) UNSIGNED ZEROFILL NOT NULL,
...
(0001, 'Administration École', 'Permet aux administrateurs de configurer les paramètres de l\'école.', 'schoolYear_manage.php', 'Core', 'Y', 'Admin', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0002, 'Administration Utilisateurs', 'Permet aux administrateurs de gérer les utilisateurs.', 'user_manage.php', 'Core', 'Y', 'Admin', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0003, 'Administration Système', 'Permet aux administrateurs de configurer les paramètres système.', 'systemOverview.php', 'Core', 'Y', 'Admin', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0004, 'Départements', 'Voir les détails d\'un département', 'departments.php', 'Core', 'Y', 'Learn', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0005, 'Élèves', 'Permet aux utilisateurs de voir les données des élèves', 'student_view.php', 'Core', 'Y', 'People', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0006, 'Présences', 'Prise des présences de l\'école', 'attendance.php', 'Core', 'Y', 'People', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0007, 'Carnet de notes', 'Un système pour suivre les notes', 'markbook_view.php', 'Core', 'Y', 'Assess', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0008, 'Mise à jour données', 'Permet aux utilisateurs de mettre à jour les données de leur famille', 'data_updates.php', 'Core', 'Y', 'People', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0009, 'Planification', 'Supporte la planification des cours et le partage d\'informations pour le personnel, les élèves et les parents', 'planner.php', 'Core', 'Y', 'Learn', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0011, 'Besoins individuels', 'Besoins individuels', 'in_view.php', 'Core', 'Y', 'Learn', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0012, 'Évaluation collaborative', 'Permet aux utilisateurs d\'évaluer le travail des autres', 'crowdAssess.php', 'Core', 'Y', 'Assess', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0013, 'Administration Emploi du temps', 'Administration de l\'emploi du temps', 'tt.php', 'Core', 'Y', 'Admin', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0014, 'Emploi du temps', 'Permet aux utilisateurs de voir les emplois du temps', 'tt.php', 'Core', 'Y', 'Learn', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0015, 'Activités', 'Gérer un programme d\'activités scolaires', 'explore.php', 'Core', 'Y', 'Learn', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0016, 'Évaluation formelle', 'Facilite le suivi des performances des élèves aux examens externes.', 'externalAssessment.php', 'Core', 'Y', 'Assess', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0119, 'Comportement', 'Suivi du comportement des élèves', 'behaviour_manage.php', 'Core', 'Y', 'People', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0121, 'Messagerie', 'Messagerie unifiée pour email, mur de messages et plus.', 'messenger_manage.php', 'Core', 'Y', 'Other', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0126, 'Grilles d\'évaluation', 'Permet aux utilisateurs de créer des grilles d\'évaluation', 'rubrics.php', 'Core', 'Y', 'Assess', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0130, 'Bibliothèque', 'Permet la gestion d\'un catalogue dont les éléments peuvent être empruntés.', 'library_manage_catalog.php', 'Core', 'Y', 'Learn', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0135, 'Finance', 'Permet à une école d\'émettre des factures et de suivre les paiements.', 'invoices_manage.php', 'Core', 'Y', 'Other', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0136, 'Personnel', 'Permet aux utilisateurs de voir les informations du personnel', 'staff_view.php', 'Core', 'Y', 'People', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0137, 'Groupes de classe', 'Permet aux utilisateurs de voir une liste des groupes de classe', 'formGroups.php', 'Core', 'Y', 'People', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0141, 'Suivi', 'Fournit des graphiques visuels du progrès des élèves, enregistrés dans le Carnet de notes et l\'Évaluation interne.', 'graphing.php', 'Core', 'Y', 'Assess', '', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0144, 'Rapports', 'Rédaction de rapports et génération PDF', 'reporting_my.php', 'Core', 'Y', 'Assess', 'v19.0.', 'Gibbon Foundation', 'https://gibbonedu.org'),
(0145, 'Admissions', 'Gestion des admissions et inscriptions', 'studentEnrolment_manage.php', 'Core', 'Y', 'People', '', 'Gibbon Foundation', 'https://gibbonedu.org');
...
CREATE TABLE `gibbonPlannerEntry` (
  ...
  `homeworkTimeCap` int DEFAULT NULL,
...
CREATE TABLE `gibbonReportingCycle` (
  ...
  `sequenceNumber` int DEFAULT NULL,
  `cycleNumber` int DEFAULT NULL,
  `cycleTotal` int DEFAULT NULL,
  `dateStart` date DEFAULT NULL,
  `dateEnd` date DEFAULT NULL,
  `milestones` text,
  `notes` text
...
(00008, 'System', 'indexText', 'Index Page Text', 'Text displayed in system\'s welcome page.', 'Welcome to Qatorze, the free, open, flexible school platform. Designed by teachers for learning, Qatorze gives you the school tools you need.'),
...
(00039, 'System', 'version', 'Version', 'The version of the Gibbon database', '30.0.00'),
...
CREATE TABLE `gibbonSpace` (
  ...
  `bookable` enum('Y','N') NOT NULL DEFAULT 'Y',
  `capacity` int NOT NULL,
  `computer` enum('N','Y') NOT NULL,
  `computerStudent` int NOT NULL DEFAULT '0',
...
CREATE TABLE `gibbonStaff` (
  ...
  `biographicalGroupingPriority` int NOT NULL,
...
CREATE TABLE `gibbonUsernameFormat` (
  ...
  `isNumeric` enum('Y','N') NOT NULL DEFAULT 'N',
...
--
-- Indexes for table `gibbonActivityCategory`
--
ALTER TABLE `gibbonActivityCategory`
  ADD PRIMARY KEY (`gibbonActivityCategoryID`),
  ADD UNIQUE KEY `name` (`name`,`gibbonSchoolYearID`);

--
-- Indexes for table `gibbonActivityChoice`
--
ALTER TABLE `gibbonActivityChoice`
  ADD PRIMARY KEY (`gibbonActivityChoiceID`),
  ADD UNIQUE KEY `gibbonPersonID` (`gibbonPersonID`,`choice`,`gibbonActivityCategoryID`);

--
-- Indexes for table `gibbonActivityPhoto`
--
ALTER TABLE `gibbonActivityPhoto`
  ADD PRIMARY KEY (`gibbonActivityPhotoID`);
...
ALTER TABLE `gibbonAttendanceLogPerson`
  ...
  ADD KEY `context` (`context`,`gibbonCourseClassID`);
...
--
-- Indexes for table `gibbonFinancePettyCash`
--
ALTER TABLE `gibbonFinancePettyCash`
  ADD PRIMARY KEY (`gibbonFinancePettyCashID`);
...
--
-- Indexes for table `gibbonMessengerMailingList`
--
ALTER TABLE `gibbonMessengerMailingList`
  ADD PRIMARY KEY (`gibbonMessengerMailingListID`);

--
-- Indexes for table `gibbonMessengerMailingListRecipient`
--
ALTER TABLE `gibbonMessengerMailingListRecipient`
  ADD PRIMARY KEY (`gibbonMessengerMailingListRecipientID`),
  ADD UNIQUE KEY `email` (`email`);
...
ALTER TABLE `gibbonMessengerReceipt`
  ...
  ADD KEY `duplicateCheck` (`gibbonMessengerID`,`gibbonPersonID`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `gibbonActivityCategory`
--
ALTER TABLE `gibbonActivityCategory`
  MODIFY `gibbonActivityCategoryID` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gibbonActivityChoice`
--
ALTER TABLE `gibbonActivityChoice`
  MODIFY `gibbonActivityChoiceID` int(12) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gibbonActivityPhoto`
--
ALTER TABLE `gibbonActivityPhoto`
  MODIFY `gibbonActivityPhotoID` int(12) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `gibbonApplicationFormLink`
  MODIFY `gibbonApplicationFormLinkID` int UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `gibbonFinancePettyCash`
--
ALTER TABLE `gibbonFinancePettyCash`
  MODIFY `gibbonFinancePettyCashID` int(12) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `gibbonMessengerMailingList`
--
ALTER TABLE `gibbonMessengerMailingList`
  MODIFY `gibbonMessengerMailingListID` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gibbonMessengerMailingListRecipient`
--
ALTER TABLE `gibbonMessengerMailingListRecipient`
  MODIFY `gibbonMessengerMailingListRecipientID` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
